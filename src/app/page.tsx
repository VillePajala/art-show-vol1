  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-24 text-center">
      <div className="max-w-lg">
        ...
        <p className="mb-8 text-lg font-[family-name:var(--font-geist-sans)]">
        ...
        <Link
          ...
          className="inline-block px-6 py-3 rounded-md bg-gray-800 text-white hover:bg-gray-700 transition-colors duration-300 font-[family-name:var(--font-geist-sans)]"
        >
          Enter Exhibition
        </Link>
      </div>
